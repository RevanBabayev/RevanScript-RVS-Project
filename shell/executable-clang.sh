...
if clang -std=c99 -O2 -c ../src/rvsarr.c -o ../object/rvsarr.o; then
	echo "Successful [rvsarr.o] object file!!!"
else
	echo "Failed [rvsarr.o] object file!!!"
fi
if clang -std=c99 -O2 -c ../src/rvsmtx.c -o ../object/rvsmtx.o; then
	echo "Successful [rvsmtx.o] object file!!!"
else
	echo "Failed [rvsmtx.o] object file!!!"
fi
if clang -static -o ../bin/clang/RevanScript ../object/*.o; then
